#эта программа работает не идёт на сайт сама, а берёт слова из файла, куда они уже записаны (см. другую программу и объяснения в ней)
#чтобы быстро потестить, удобнее, наверно, запустить эту программу, а не ту
